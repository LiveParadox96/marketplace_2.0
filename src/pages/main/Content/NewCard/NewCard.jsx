      ...
      <div className="Card_new">
        ...
        <div className="Card-container_new">
          ...
          <div className="Card-discriptiom_new_rating">
            <div className="Card-rating-count_new">{rating.count} штук осталось</div>
            <div className="Card-rating-rate_new">{rating.rate}- рейтинг пользователей</div>
          </div>
          <div className="Card-price_new common-price_new">{price}</div>
